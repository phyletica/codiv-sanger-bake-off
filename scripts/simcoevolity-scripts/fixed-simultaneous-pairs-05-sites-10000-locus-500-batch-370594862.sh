...
then
    ...
    cd /gpfs01/home/rlk0015/codiv-sanger-bake-off/scripts/simcoevolity-scripts
else
...
output_dir="../../simulations/fixed-simultaneous-pairs-05-sites-10000-locus-500/batch-370594862"
