...
then
    ...
    cd /gpfs01/home/cbt0022/codiv-sanger-bake-off/scripts/simcoevolity-scripts
else
...
output_dir="../../simulations/fixed-simultaneous-pairs-05-sites-10000-locus-500/batch-357774469"
