...
then
    ...
    cd /gpfs01/scratch/jro0014/codiv-sanger-bake-off/scripts/simcoevolity-scripts
else
...
output_dir="../../simulations/fixed-simultaneous-pairs-05-sites-02500-locus-500/batch-213407271"
