...
then
    ...
    cd /gpfs01/scratch/tcm0036/codiv-sanger-bake-off/scripts/simcoevolity-scripts
else
...
number_of_reps=20
locus_size=500
config_path="../../configs/fixed-simultaneous-pairs-05-sites-02500.yml"
prior_config_path="../../configs/pairs-05-sites-02500.yml"
output_dir="../../simulations/fixed-simultaneous-pairs-05-sites-02500-locus-500/batch-443425945"
