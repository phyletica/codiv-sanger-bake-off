...
\begin{figure}
    ...
    \begin{tabular}{@{}ccc@{}}
        ...
        & \includegraphics[width=0.5\textwidth]{../free-no-y-label-violin-cropped.pdf}
        & \multirow{1}{*}[10.5em]{\begin{sideways}\Large Dirichlet process\end{sideways}} \\
        & \includegraphics[width=0.5\textwidth]{../independent-no-y-label-violin-cropped.pdf}
        & \multirow{1}{*}[9.4em]{\begin{sideways}\Large Independent\end{sideways}} \\
        & \includegraphics[width=0.5\textwidth]{../simultaneous-no-y-label-violin-cropped.pdf}
