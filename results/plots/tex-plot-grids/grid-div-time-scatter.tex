...
\begin{figure}
    ...
    \centering
    \begin{tabular}{@{}cc@{}}
        \includegraphics[width=0.5\textwidth]{../free-div-time-scatter-cropped.pdf}
        & \multirow{1}{*}[15.5em]{\begin{sideways}\Large Dirichlet process\end{sideways}} \\
        \includegraphics[width=0.5\textwidth]{../independent-div-time-scatter-cropped.pdf}
        & \multirow{1}{*}[14.4em]{\begin{sideways}\Large Independent\end{sideways}} \\
        \includegraphics[width=0.5\textwidth]{../simultaneous-div-time-scatter-cropped.pdf}
