...
\begin{figure}
    ...
    \centering
    \begin{tabular}{@{}cc@{}}
        \includegraphics[width=0.5\textwidth]{../free-psrf-root-pop-size-histograms-cropped.pdf}
        & \multirow{1}{*}[10.5em]{\begin{sideways}\Large Dirichlet process\end{sideways}} \\
        \includegraphics[width=0.5\textwidth]{../independent-psrf-root-pop-size-histograms-cropped.pdf}
        & \multirow{1}{*}[9.4em]{\begin{sideways}\Large Independent\end{sideways}} \\
        \includegraphics[width=0.5\textwidth]{../simultaneous-psrf-root-pop-size-histograms-cropped.pdf}
