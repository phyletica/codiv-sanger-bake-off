...
project = u'Codivergence bake-off'
...
htmlhelp_basename = 'codiv-sanger-bake-offdoc'
...
latex_documents = [
    (master_doc, 'codiv-sanger-bake-off.tex', u'Codivergence Bake-off Documentation',
     u'Jamie Oaks', 'manual'),
]
...
man_pages = [
    (master_doc, 'codiv-sanger-bake-off', u'Codivergence Bake-off Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'codiv-sanger-bake-off', u'Codivergence Bake-off Documentation',
     author, 'codiv-sanger-bake-off', 'Comparing methods for estimaing codivergences from Sanger data.',
     'Miscellaneous'),
]
...
.. _project_repo: https://github.com/phyletica/codiv-sanger-bake-off
.. |doc_site| replace:: project site 
.. _doc_site: http://phyletica.org/codiv-sanger-bake-off
.. |doc_url| replace:: http://phyletica.org/codiv-sanger-bake-off
