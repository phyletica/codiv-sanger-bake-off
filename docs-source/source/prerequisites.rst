...
Several Python scripts are used in this project, and we provide a shell script
that allows you to easily set up a Python virtual environment for these scripts
